...
if (!class_exists('ClassifiedAppLatestRoutes')) {

    class ClassifiedAppLatestRoutes extends WP_REST_Controller
    {
        ...
        public function register_routes() {
            ...
            register_rest_route($namespace, '/' . $base,
                ...
                array(
                    ...
                    'callback' => array($this, 'get_latest_ads'),
                    'args' => array(
                    ),
                ),
            ));
         ...
         */
        public function get_latest_ads($request) {
			$query_args = array(
				'posts_per_page' => 10,
			...
			if ($query->have_posts()) {
				while ($query->have_posts()) {
					...
					if (function_exists('fw_get_db_post_option')) {
						...
						$feature_data = get_post_meta($post->ID, 'featured', true);
					}                    
...
add_action('rest_api_init', function () {
    $controller = new ClassifiedAppLatestRoutes;
